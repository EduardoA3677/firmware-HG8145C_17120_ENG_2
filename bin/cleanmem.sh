...
CheckProcess()
{
        ...
        KillProcessFivetimeNormal aging

        KillProcessFivetimeNormal radvd

        KillProcessFivetimeNormal dhcp6s
...
echo "rmmod skpool.ko for mu upgrade: "
rmmod /lib/modules/wap/skpool.ko
echo "rmmod skpool.ko for mu upgrade success! "
